...
# load dataset
raw_dataset = load_clean_sentences('data/english-vietnamese-all.pkl')
# reduce dataset size
n_sentences = 40218
...
write_hdf5(int(n_sentences * 0.8), 'hdf5/translate_train_all.hdf5', ger_length, eng_length, eng_vocab_size, trainX, trainY, outTrainY)
write_hdf5(n_sentences - int(n_sentences * 0.8), 'hdf5/translate_test_all.hdf5', ger_length, eng_length, eng_vocab_size, testX, testY, outTestY)
save_clean_data(dataset, 'data/english-vietnamese-both-all.pkl')
save_clean_data(test, 'data/english-vietnamese-test-all.pkl')
